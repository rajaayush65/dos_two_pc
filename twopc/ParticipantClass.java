...
public class ParticipantClass {
	...
	private void initialize() {
		...
		frame.getContentPane().setBackground(new java.awt.Color(230, 126, 34)); 
		...
		btnAbort.setBounds(320, 50, 106, 37);
		...
		btnCommit.setBounds(180, 50, 106, 37);
...
*/		JLabel lblEnterParticipantName = new JLabel("Enter Participant Name");
		...
		scrollPane.setBounds(160, 101, 300, 157);
		...
		btnState.setBounds(40, 150, 106, 37);
		frame.getContentPane().add(btnState);
		
		lblNewLabel = new JLabel("");
		lblNewLabel.setBounds(50, 70, 68, 14);
