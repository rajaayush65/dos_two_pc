...
public class CoordinatorClass {
	...
	private void initialize() {
		...
		frmCoordinator.getContentPane().setBackground(new java.awt.Color(230, 126, 34));
		...
		scrollPane.setBounds(20, 100, 360, 185);
		...
		btnState.setBounds(180, 300, 89, 23);
